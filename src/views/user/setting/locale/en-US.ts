export default {
  ...
  'menu.scan.manager': 'Manufacturer management',
  'menu.scan.subdomain': 'Subdomain management',
  'menu.scan.webinfo': 'Webinfo management',
  'menu.scan.ports': 'Ports management',
  'menu.scan.engine': 'Engine management',
  'menu.scan.fingerprint': 'Fingerprint management',
  ...
  'userSetting.basicInfo.placeholder.phone': `Please enter your phone`,
  ...
  'userSetting.form.error.phone.required': 'Please enter phone',
