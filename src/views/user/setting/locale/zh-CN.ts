export default {
  ...
  'menu.scan.manager': '厂商管理',
  'menu.scan.subdomain': '子域名管理',
  'menu.scan.webinfo': '网站信息管理',
  'menu.scan.ports': '端口信息管理',
  'menu.scan.engine': '扫描引擎管理',
  'menu.scan.fingerprint': '指纹库管理',
  ...
  'userSetting.basicInfo.form.label.phone': '手机号',
  'userSetting.basicInfo.placeholder.email': `请输入邮箱地址，如xxx{'@'}bytedance.com`,
  'userSetting.basicInfo.placeholder.phone': `请输入手机号`,
  ...
  'userSetting.form.error.phone.required': '请输入手机号',
