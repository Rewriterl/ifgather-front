<template>
  <div class="container">
    <Breadcrumb :items="['menu.scan', 'menu.scan.subdomain']" />
          ...
          >
            <a-row>
              ...
              <a-col :span="12">
                <a-form-item
                  field="searchParams"
                  :label="$t('searchTable.columns.location')"
                >
                  <a-input
                    v-model="formModel.searchParams.Location"
                    :placeholder="$t('searchTable.columns.location')"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                <a-form-item
                  field="searchParams"
                  :label="$t('searchTable.columns.subdomain')"
                >
                  <a-input
                    v-model="formModel.searchParams.SubDomain"
                    :placeholder="$t('searchTable.columns.subdomain')"
                  />
                </a-form-item>
              </a-col>
            </a-row>
...
<script lang="ts" setup>
  ...
  import { getSubDomainList } from '@/api/subdomain';
  ...
  const columns = computed<TableColumnData[]>(() => [
    ...
    {
      title: t('searchTable.columns.cdn'),
      dataIndex: 'cdn',
    },
    {
      title: t('searchTable.columns.cname'),
      dataIndex: 'cname',
    },
    {
  ...
  const fetchData = async (
    ...
    setLoading(true);
    try {
      const data: any = await getSubDomainList(params);
