          ...
          >
            <a-row>
              ...
              <a-col :span="12">
                <a-form-item
                  field="searchParams"
                  :label="$t('searchTable.columns.theme')"
                >
                  <a-input
                    v-model="formModel.searchParams.theme"
                    :placeholder="$t('searchTable.columns.theme')"
                  />
                </a-form-item>
              </a-col>
              <a-col :span="12">
                ...
                >
                  <a-input
                    v-model="formModel.searchParams.content"
                    :placeholder="$t('searchTable.columns.content')"
                  />
                </a-form-item>
              </a-col>
            </a-row>
...
<script lang="ts" setup>
  ...
  import { getLoginLogs, getOptLogs } from '@/api/log';
  ...
  const columns = computed<TableColumnData[]>(() => [
    ...
    {
      title: t('searchTable.columns.theme'),
      dataIndex: 'theme',
    },
    {
  ...
  const fetchData = async (
    ...
    setLoading(true);
    try {
      const data: any = await getOptLogs(params);
