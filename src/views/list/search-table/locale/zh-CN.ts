export default {
  ...
  'searchTable.scan.task': '任务名称',
  'searchTable.fingerprint.name': '指纹名',
  'searchTable.fingerprint.description': '指纹描述',
  ...
  'searchTable.columns.domain_num': '域名数',
  'searchTable.columns.scan_num': '扫描数',
